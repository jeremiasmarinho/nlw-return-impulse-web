...
export function FeedbackContentStep({
  ...
  const [idSendingFeedback, setIdSendingFeedback] = useState(false);
    ...
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            type="submit"
            disabled={comment.length == 0 || idSendingFeedback}
          ...
          >
            {idSendingFeedback ? <Loading /> : 'Enviar feedback'}
          </button>
        </footer>
      </form>
    </>
